...
class CreditsIcon extends FlxSprite
{
	...
	public function new(char:String = 'teles', isPlayer:Bool = false)
	{
		super();
		updateIcon(char, isPlayer);
	}

	public function updateIcon(char:String = 'teles', isPlayer:Bool = false)
	{
		...
		var iconPath = char;
		if (!FileSystem.exists(Paths.getPath('images/credits/' + iconPath + '.png', IMAGE)))
		{
		...
		antialiasing = true;
		var iconGraphic:FlxGraphic = Paths.image('credits/' + iconPath);
