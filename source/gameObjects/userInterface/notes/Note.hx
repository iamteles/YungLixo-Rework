		...
		switch (assetModifier)
		{
			...
			default: // base game arrows for no reason whatsoever
				...
				switch(noteType)
				{
					case 1:
					{
						newNote.frames = Paths.getSparrowAtlas(ForeverTools.returnSkinAsset('warns', assetModifier, Init.trueSettings.get("Note Skin"), 'noteskins/mines'));
					...
					case 2:
					{
						newNote.frames = Paths.getSparrowAtlas(ForeverTools.returnSkinAsset('third', assetModifier, Init.trueSettings.get("Note Skin"), 'noteskins/mines'));
						newNote.animation.addByPrefix('greenScroll', 'green0');
						newNote.animation.addByPrefix('redScroll', 'red0');
						newNote.animation.addByPrefix('blueScroll', 'blue0');
						newNote.animation.addByPrefix('purpleScroll', 'purple0');
